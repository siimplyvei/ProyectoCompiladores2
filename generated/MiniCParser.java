...
public class MiniCParser extends Parser {
	...
	public static final int
		...
		RULE_forStmt = 19, RULE_forInit = 20, RULE_forCond = 21, RULE_forStep = 22, 
		RULE_relationalExpr = 23, RULE_additiveExpr = 24, RULE_multiplicativeExpr = 25, 
		RULE_unaryExpr = 26, RULE_primary = 27, RULE_call = 28, RULE_lvalue = 29;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"logicalAndExpr", "equalityExpr", "forStmt", "forInit", "forCond", "forStep", 
	...
	public final ForStepContext forStep() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_forStep);
		try {
			setState(213);
			_errHandler.sync(this);
